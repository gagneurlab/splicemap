...
zenodo_base_url = {
    'gtex_v8': 'https://zenodo.org/record/6387938/files/',
...
splicemap_url = {
    'gtex_v8': [
        *[complete_url(tissue, 'psi5', 'gtex_v8') for tissue in gtex_v8_tissues],
        *[complete_url(tissue, 'psi3', 'gtex_v8') for tissue in gtex_v8_tissues]
    ],
    'gtex_v7': [
        *[complete_url(tissue, 'psi5', 'gtex_v7') for tissue in gtex_v7_tissues],
        *[complete_url(tissue, 'psi3', 'gtex_v7') for tissue in gtex_v7_tissues]
    ]
}
...
@click.command()
@click.option('--version', help='SpliceMap version (currently SpliceMaps from gtex_v8 (hg38) and gtex_v7 (hg19) supported)')
